...
namespace Appoa.Web.UI
{
    public class UpLoad
    {
        ...
        public string fileSaveAs(HttpPostedFile postedFile, bool isThumbnail, bool isWater, string folder)
        {
            try
            {
                ...
                string upLoadPath = GetUpLoadPath(folder); //上传目录相对路径
        ...
        public string remoteSaveAs(string fileUri, string folder)
        {
        ...
        private string GetUpLoadPath(string folder)
        {
            ...
            {
                path = siteConfig.webpath + siteConfig.filepath + "/" + folder + "/"; //站点目录+上传目录+文件夹
            }
