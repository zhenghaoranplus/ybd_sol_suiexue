...
using Appoa.Common.ZipLib.Encryption;
#endif

using Appoa.Common.ZipLib.Core;
using Appoa.Common.ZipLib.Checksums;
using Appoa.Common.ZipLib.Zip.Compression.Streams;
using Appoa.Common.ZipLib.Zip.Compression;

namespace Appoa.Common.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Appoa.Common.ZipLib.Zip.ZipException">
