...
namespace Appoa.Common
{
    public class CacheHelper
    {
        ...
        public static void InsertDateTime(string key, object obj, int seconds)
        {
            HttpContext.Current.Cache.Insert(key, obj, null, System.DateTime.Now.AddSeconds(seconds), TimeSpan.Zero);
        }
