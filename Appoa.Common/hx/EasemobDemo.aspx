...
<script runat="server">
    ...
    /// 设置app的基本信息
    /// </summary>
    string appName = "comyibingdingeet7", orgName = "yibingding";
...
<div class="msgContainer">
  <ul class="baiduPush">
    <li><span>client_id:</span><asp:TextBox ID="txtClient_id" runat="server" Width="400px" Text="YXA69tmPYEy6Eea98s0ssfVnyw"/><div class="clear"></div></li>
    <li><span>client_secret:</span><asp:TextBox ID="txtClient_secret" runat="server" Width="400px" Text="YXA6CfxIylE0QDdbT8Did9lHQ51VJSY"/><div class="clear"></div></li>
