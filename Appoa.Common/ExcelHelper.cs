    ...
    public class ExcelHelper
    {
        ...
        public static void DataTable3Excel(System.Data.DataTable dtData, String FileName)
        {
            ...
            if (dtData != null)
            {
                ...
                if (curContext.Request.Browser.Type.ToLower().Contains("firefox"))
                {
                    curContext.Response.AddHeader("content-disposition", "attachment;filename=" + System.Text.RegularExpressions.Regex.Unescape(FileName) + ".xls");
                }
                else
                {
                ...
                dgExport.AllowPaging = false;
                dgExport.DataBind();
                dgExport.HeaderRow.Height = 40;
                dgExport.HeaderRow.Font.Size = 12;
                dgExport.RenderControl(htmlWriter);
                curContext.Response.Write(strWriter.ToString());
                curContext.Response.End();
            }
