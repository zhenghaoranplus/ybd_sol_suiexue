...
namespace Appoa.Common
{
    public class AppoaKeys
    {
        ...
        /// 惠家服务范围(地理位置)缓存
        /// </summary>Polygon
        public const string CACHE_CT_POLYGON = "ybd_mbb_ct_polygon";
        ...
        /// 商家后台管理员
        /// </summary>
        public const string SESSION_CT_INFO = "dt_session_ct_info";
        /// <summary>
        /// 会员用户
        /// </summary>
        ...
        /// 一般用户
        /// </summary>
        public const string SESSION_USER_USER_INFO = "dt_session_user_user_info";
        //Cookies=====================================================
        /// <summary>
        /// 防重复顶踩KEY
        /// </summary>
