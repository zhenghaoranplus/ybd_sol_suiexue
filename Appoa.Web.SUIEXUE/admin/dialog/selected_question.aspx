<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selected_question.aspx.cs" Inherits="Appoa.Manage.admin.dialog.selected_question" %>
            ...
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        ...
                        <div>
                            <asp:Label ID="lblCount" runat="server" class="btn" Text="共 0 道题目，总分 0 分"></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
