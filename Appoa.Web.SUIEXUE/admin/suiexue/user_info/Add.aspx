<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Appoa.Manage.admin.user_info.Add" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>用户信息管理</span></a> <i class="arrow"></i><span>添加用户信息</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div class="tab-content">
            ...
            <dl>
                <dt>手机号</dt>
                <dd>
                    <asp:TextBox ID="txtphone" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>随机加密字符串</dt>
                <dd>
                    <asp:TextBox ID="txtsalt" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>密码</dt>
                <dd>
                    <asp:TextBox ID="txtuser_pwd" runat="server" CssClass="input normal" datatype="*0-200" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>昵称</dt>
                <dd>
                    <asp:TextBox ID="txtnick_name" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>头像</dt>
                <dd>
                    <asp:TextBox ID="txtavatar" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>积分</dt>
                <dd>
                    <asp:TextBox ID="txtintegral" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>院系</dt>
                <dd>
                    <asp:TextBox ID="txtcollege" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>职位</dt>
                <dd>
                    <asp:TextBox ID="txtjob" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>所授课程</dt>
                <dd>
                    <asp:TextBox ID="txtcourse" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>联系方式</dt>
                <dd>
                    <asp:TextBox ID="txtline_way" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>区域</dt>
                <dd>
                    <asp:TextBox ID="txtarea" runat="server" CssClass="input normal" datatype="*0-200" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*200字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>详细地址</dt>
                <dd>
                    <asp:TextBox ID="txtaddress" runat="server" CssClass="input normal" datatype="*0-200" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*200字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>注册IP</dt>
                <dd>
                    <asp:TextBox ID="txtreg_ip" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
