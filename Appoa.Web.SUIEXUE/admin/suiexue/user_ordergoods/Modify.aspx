<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.user_ordergoods.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>订单购买商品表管理</span></a> <i class="arrow"></i><span>修改订单购买商品表</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">订单购买商品表信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            <dl>
                <dt>订单id</dt>
                <dd>
                    <asp:TextBox ID="txtorder_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>商品分组</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_group" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>商品id</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>标题</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_title" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>副标题</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_subtitle" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>规格</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_spec" runat="server" CssClass="input normal" datatype="*0-4000" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>库存</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_stock" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>原价</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_oprice" runat="server" CssClass="input normal" datatype="*0-8" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>现价</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_price" runat="server" CssClass="input normal" datatype="*0-8" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*8字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>数量</dt>
                <dd>
                    <asp:TextBox ID="txtquantity" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
