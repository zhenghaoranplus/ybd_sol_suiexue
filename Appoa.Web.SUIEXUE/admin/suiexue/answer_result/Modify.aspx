<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.answer_result.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>答题结果管理</span></a> <i class="arrow"></i><span>修改答题结果</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">答题结果信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            ...
            <dl>
                <dt>试卷ID</dt>
                <dd>
                    <asp:TextBox ID="txtexa_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>试卷标题</dt>
                <dd>
                    <asp:TextBox ID="txtexa_title" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>头像</dt>
                <dd>
                    <asp:TextBox ID="txtavatar" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>用时-分钟</dt>
                <dd>
                    <asp:TextBox ID="txtuse_min" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>用时-秒钟</dt>
                <dd>
                    <asp:TextBox ID="txtuse_sec" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>答对题数</dt>
                <dd>
                    <asp:TextBox ID="txttruth_num" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>总题数</dt>
                <dd>
                    <asp:TextBox ID="txtcount" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>正确率</dt>
                <dd>
                    <asp:TextBox ID="txttruth_ratio" runat="server" CssClass="input normal" datatype="*0-5" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*5字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>总分</dt>
