...
namespace Appoa.Manage.admin.answer_result
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_answer_result", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_answer_result", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.answer_result bll = new BLL.answer_result();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除答题结果" + sucCount + "条，失败" + errorCount + "条"); //记录日志
