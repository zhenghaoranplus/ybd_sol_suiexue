<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.common_message.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>全局消息管理</span></a> <i class="arrow"></i><span>修改全局消息</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">全局消息信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            ...
            <dl>
                <dt>内容</dt>
                <dd>
                    <asp:TextBox ID="txtcontents" runat="server" CssClass="input normal" datatype="*0-4000" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>发送者ID</dt>
                <dd>
                    <asp:TextBox ID="txtsender_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>接收者ID</dt>
                <dd>
                    <asp:TextBox ID="txtreceiver_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>是否读取</dt>
                <dd>
                    <asp:TextBox ID="txtis_read" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>是否已推送</dt>
                <dd>
                    <asp:TextBox ID="txtis_send" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>推送时间</dt>
                <dd>
                    <asp:TextBox ID="txtsend_time" runat="server" CssClass="input normal" datatype="*0-8" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*8字以内</span>
                </dd>
            </dl>
