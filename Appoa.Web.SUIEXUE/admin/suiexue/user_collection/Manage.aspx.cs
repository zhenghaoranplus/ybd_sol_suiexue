...
namespace Appoa.Manage.admin.user_collection
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_user_collection", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_user_collection", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.user_collection bll = new BLL.user_collection();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除用户收藏" + sucCount + "条，失败" + errorCount + "条"); //记录日志
