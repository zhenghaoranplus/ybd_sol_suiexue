<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Appoa.Manage.admin.user_collection.Manage" ValidateRequest="false" %> 
...
<body class="mainbody">
    ...
    <div class="location">
        ...
        <i class="arrow"></i><span>用户收藏列表</span>
    </div>
    <!--/导航栏-->
    <!--工具栏-->
