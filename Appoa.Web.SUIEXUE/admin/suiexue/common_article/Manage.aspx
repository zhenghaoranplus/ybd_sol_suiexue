<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Appoa.Manage.admin.common_article.Manage" ValidateRequest="false" %> 
...
<body class="mainbody">
    ...
    <div class="location">
        ...
        <i class="arrow"></i><span>全局文章列表</span>
    </div>
    <!--/导航栏-->
    <!--工具栏-->
