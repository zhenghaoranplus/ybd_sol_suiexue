...
namespace Appoa.Manage.admin.answer_record
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_answer_record", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_answer_record", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.answer_record bll = new BLL.answer_record();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除答题记录" + sucCount + "条，失败" + errorCount + "条"); //记录日志
