<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.user_tree.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>用户关系管理</span></a> <i class="arrow"></i><span>修改用户关系</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">用户关系信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            ...
            <dl>
                <dt>唯一标识code</dt>
                <dd>
                    <asp:TextBox ID="txtcode" runat="server" CssClass="input normal" datatype="*0-10" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*10字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>父级code</dt>
                <dd>
                    <asp:TextBox ID="txtparent_code" runat="server" CssClass="input normal" datatype="*0-10" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*10字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>父级的父级code</dt>
                <dd>
                    <asp:TextBox ID="txtgrand_code" runat="server" CssClass="input normal" datatype="*0-10" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*10字以内</span>
                </dd>
            </dl>
