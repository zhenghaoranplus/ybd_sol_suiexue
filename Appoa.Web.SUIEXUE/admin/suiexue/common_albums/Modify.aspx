<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.common_albums.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>全局相册管理</span></a> <i class="arrow"></i><span>修改全局相册</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">全局相册信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            ...
            <dl>
                <dt>标题</dt>
                <dd>
                    <asp:TextBox ID="txtrc_title" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>关联内容分类id</dt>
                <dd>
                    <asp:TextBox ID="txtrc_type" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>关联内容数据ID</dt>
                <dd>
                    <asp:TextBox ID="txtrc_data_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>缩略图地址</dt>
                <dd>
                    <asp:TextBox ID="txtthumb_path" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>原图地址</dt>
                <dd>
                    <asp:TextBox ID="txtoriginal_path" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*255字以内</span>
                </dd>
            </dl>
            <dl>
