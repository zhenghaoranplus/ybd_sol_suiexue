...
namespace Appoa.Manage.admin.common_feedback
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_common_feedback", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_common_feedback", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.common_feedback bll = new BLL.common_feedback();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除全局反馈记录" + sucCount + "条，失败" + errorCount + "条"); //记录日志
