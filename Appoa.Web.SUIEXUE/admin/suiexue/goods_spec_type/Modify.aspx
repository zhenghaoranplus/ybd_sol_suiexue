<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.goods_spec_type.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>商品规格种类管理</span></a> <i class="arrow"></i><span>修改商品规格种类</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">商品规格种类信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            ...
            <dl>
                <dt>规格</dt>
                <dd>
                    <asp:TextBox ID="txtspec" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>库存</dt>
                <dd>
                    <asp:TextBox ID="txtstock" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>价格</dt>
                <dd>
                    <asp:TextBox ID="txtprice" runat="server" CssClass="input normal" datatype="*0-9" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*9字以内</span>
                </dd>
            </dl>
