...
namespace Appoa.Manage.admin.goods_spec_type
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_goods_spec_type", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_goods_spec_type", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.goods_spec_type bll = new BLL.goods_spec_type();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除商品规格种类" + sucCount + "条，失败" + errorCount + "条"); //记录日志
