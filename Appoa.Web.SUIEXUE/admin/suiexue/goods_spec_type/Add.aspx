<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Appoa.Manage.admin.goods_spec_type.Add" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>商品规格种类管理</span></a> <i class="arrow"></i><span>添加商品规格种类</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
