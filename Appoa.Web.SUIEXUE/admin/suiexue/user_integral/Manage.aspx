<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Appoa.Manage.admin.user_integral.Manage" ValidateRequest="false" %> 
...
<body class="mainbody">
    ...
    <div class="location">
        ...
        <i class="arrow"></i><span>积分记录列表</span>
    </div>
    <!--/导航栏-->
    <!--工具栏-->
