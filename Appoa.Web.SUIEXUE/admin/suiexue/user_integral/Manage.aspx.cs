...
namespace Appoa.Manage.admin.user_integral
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_user_integral", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_user_integral", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.user_integral bll = new BLL.user_integral();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除积分记录" + sucCount + "条，失败" + errorCount + "条"); //记录日志
