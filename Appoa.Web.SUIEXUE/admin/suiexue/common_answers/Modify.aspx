<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.common_answers.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>选项信息管理</span></a> <i class="arrow"></i><span>修改选项信息</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">选项信息信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            <dl>
                <dt>题目ID</dt>
                <dd>
                    <asp:TextBox ID="txtquestion_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>选项</dt>
                <dd>
                    <asp:TextBox ID="txtoptions" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
