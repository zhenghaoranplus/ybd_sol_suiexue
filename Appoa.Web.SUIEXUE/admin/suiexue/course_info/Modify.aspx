<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.course_info.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>课程信息管理</span></a> <i class="arrow"></i><span>修改课程信息</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">课程信息信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            ...
            <dl>
                <dt>简介</dt>
                <dd>
                    <asp:TextBox ID="txtinfo" runat="server" CssClass="input normal" datatype="*0-4000" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>公告</dt>
                <dd>
                    <asp:TextBox ID="txtnotice" runat="server" CssClass="input normal" datatype="*0-4000" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4000字以内</span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>二维码logo</dt>
                <dd>
                    <asp:TextBox ID="txtqrcode_logo" runat="server" CssClass="input normal" datatype="*0-500" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*500字以内</span>
                </dd>
            </dl>
            <dl>
