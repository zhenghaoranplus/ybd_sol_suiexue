<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Appoa.Manage.admin.common_questions.Add" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>题目信息管理</span></a> <i class="arrow"></i><span>添加题目信息</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">题目信息信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            ...
            <dl>
                <dt>序号</dt>
                <dd>
                    <asp:TextBox ID="txtnumber" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>参考答案</dt>
                <dd>
                    <asp:TextBox ID="txtanswer" runat="server" CssClass="input normal" datatype="*0-4000" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>分值</dt>
                <dd>
                    <asp:TextBox ID="txtscore" runat="server" CssClass="input normal" datatype="*0-5" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>解析</dt>
                <dd>
                    <asp:TextBox ID="txtanalysis" runat="server" CssClass="input normal" datatype="*0-2000" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*2000字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>添加时间</dt>
