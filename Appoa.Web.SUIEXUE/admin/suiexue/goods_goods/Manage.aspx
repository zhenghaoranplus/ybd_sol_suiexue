<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Appoa.Manage.admin.goods_goods.Manage" ValidateRequest="false" %> 
                ...
                <tr>
                    <td align="center">
                        ...
                        <asp:HiddenField ID="hidId" Value='<%#Eval("ID")%>' runat="server" />
                            ...
                            <td>
                                <%#Eval("sj_time","{0:yyyy-MM-dd}")%>
                            </td>
                            <td>
                                <%#Eval("xj_time","{0:yyyy-MM-dd}")%>
                            </td>
                            <td>
