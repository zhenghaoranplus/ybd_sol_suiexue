<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Appoa.Manage.admin.user_cart.Add" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>购物车表管理</span></a> <i class="arrow"></i><span>添加购物车表</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
