...
namespace Appoa.Manage.admin.user_cart
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_user_cart", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_user_cart", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.user_cart bll = new BLL.user_cart();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除购物车表" + sucCount + "条，失败" + errorCount + "条"); //记录日志
