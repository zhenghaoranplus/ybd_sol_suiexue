<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.user_cart.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>购物车表管理</span></a> <i class="arrow"></i><span>修改购物车表</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">购物车表信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            ...
            <dl>
                <dt>商品销售类型</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_sale_type" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>标题</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_name" runat="server" CssClass="input normal" datatype="*0-200" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>副标题</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_subtitle" runat="server" CssClass="input normal" datatype="*0-200" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*200字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>封面图</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_img" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>规格id</dt>
                <dd>
                    <asp:TextBox ID="txtgoods_spec_id" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*255字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>数量</dt>
                <dd>
                    <asp:TextBox ID="txtnum" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
