<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Appoa.Manage.admin.common_adR.Modify" ValidateRequest="false" %> 
<!DOCTYPE html>
<html>
<head>
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="Manage.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="Manage.aspx">
                <span>广告位与数据对应管理</span></a> <i class="arrow"></i><span>修改广告位与数据对应</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">广告位与数据对应信息</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
            <dl>
                <dt>广告分组id</dt>
                <dd>
                    <asp:TextBox ID="txtad_group_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>广告分组名称</dt>
                <dd>
                    <asp:TextBox ID="txtad_group_name" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>广告类型id</dt>
                <dd>
                    <asp:TextBox ID="txtad_type_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>广告类型name</dt>
                <dd>
                    <asp:TextBox ID="txtad_type_name" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>广告数据id</dt>
                <dd>
                    <asp:TextBox ID="txtad_data_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>广告数据标题</dt>
                <dd>
                    <asp:TextBox ID="txtad_data_title" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*50字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>广告数据副标题</dt>
                <dd>
                    <asp:TextBox ID="txtad_data_subtitle" runat="server" CssClass="input normal" datatype="*0-500" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>广告数据图片</dt>
                <dd>
                    <asp:TextBox ID="txtad_data_img" runat="server" CssClass="input normal" datatype="*0-500" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*500字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>广告位链接</dt>
                <dd>
                    <asp:TextBox ID="txtad_data_url" runat="server" CssClass="input normal" datatype="*0-500" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*500字以内</span>
                </dd>
            </dl>
            <dl>
                <dt>排序</dt>
                <dd>
                    <asp:TextBox ID="txtad_sort_id" runat="server" CssClass="input normal" datatype="n" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*4字以内</span>
                </dd>
            </dl>
            <dl>
