...
namespace Appoa.Manage.admin.company_info
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_company_info", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_company_info", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.company_info bll = new BLL.company_info();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除集团子公司信息" + sucCount + "条，失败" + errorCount + "条"); //记录日志
