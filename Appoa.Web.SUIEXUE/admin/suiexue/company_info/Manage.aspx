<%@Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Appoa.Manage.admin.company_info.Manage" ValidateRequest="false" %> 
...
<body class="mainbody">
    ...
    <div class="location">
        ...
        <i class="arrow"></i><span>集团子公司信息列表</span>
    </div>
    <!--/导航栏-->
    <!--工具栏-->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        <th width="8%">
                            ...
                            <th align="left">
                                我们能做什么文字[[中文,英文],[中文,英文],[中文,英文],[中文,英文]]
                            </th>
                            <th align="left">
                                我们能做什么右侧图
                            </th>
