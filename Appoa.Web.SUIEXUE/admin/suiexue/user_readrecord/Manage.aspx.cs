...
namespace Appoa.Manage.admin.user_readrecord
{
    public partial class Manage : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_user_readrecord", EnumCollection.ActionEnum.Manage.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            ChkAdminLevel("_ybd_user_readrecord", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.user_readrecord bll = new BLL.user_readrecord();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除用户阅读记录" + sucCount + "条，失败" + errorCount + "条"); //记录日志
