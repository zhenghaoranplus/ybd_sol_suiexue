<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="integral_rule.aspx.cs" Inherits="Appoa.Manage.admin.common.integral_rule" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">积分规则</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            <dl>
                <dt>标题</dt>
                <dd>
                    <asp:TextBox ID="txttitle" runat="server" CssClass="input normal" datatype="*0-200" sucmsg=" " Text="积分规则"></asp:TextBox>
