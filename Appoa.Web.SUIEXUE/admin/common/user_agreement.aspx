<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_agreement.aspx.cs" Inherits="Appoa.Manage.admin.common.user_agreement" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">用户协议</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            <dl>
                <dt>标题</dt>
                <dd>
                    <asp:TextBox ID="txttitle" runat="server" CssClass="input normal" datatype="*0-200" sucmsg=" " Text="用户协议"></asp:TextBox>
