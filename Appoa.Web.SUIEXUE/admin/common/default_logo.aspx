<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default_logo.aspx.cs" Inherits="Appoa.Manage.admin.common.default_logo" %>
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">默认二维码logo</a></li>
                    </ul>
                </div>
            </div>
        </div>
