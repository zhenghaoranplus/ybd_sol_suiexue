<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="question_chapter_list.aspx.cs" Inherits="Appoa.Manage.admin.common.question_chapter_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i><span>课程章节列表</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <a href="questions_list.aspx?chapter=<%#Eval("Id")%>">试题管理</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
