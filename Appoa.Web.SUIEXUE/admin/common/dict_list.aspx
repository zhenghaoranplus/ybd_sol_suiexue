<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dict_list.aspx.cs" Inherits="Appoa.Manage.admin.common.dict_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i><span>字典项配置列表</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="dict_edit.aspx?action=<%=EnumCollection.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <a href="dict_edit.aspx?action=<%=EnumCollection.ActionEnum.Modify %>&id=<%#Eval("Id")%>&page=<%=RequestHelper.GetQueryInt("page", 1) %>">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
