...
{
    public partial class question_course_list : Web.UI.ManagePage
    {
        ...
        private void BindData()
        {
            ...
            if (!string.IsNullOrEmpty(_keywords))
            {
                ...
                {
                    JscriptMsg("搜索关键词中包含危险字符，检索终止！", Utils.CombUrlTxt("question_course_list.aspx", "keywords={0}", ""));
                    return;
                }
            }
            ...
            string pageUrl = Utils.CombUrlTxt("question_course_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("question_course_page_size", "AppoaPage"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("question_course_list.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("question_course_page_size", "AppoaPage", _pagesize.ToString(), 14400);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("question_course_list.aspx", "keywords={0}", this.keywords));
        }

        protected void ddlCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("question_course_list.aspx", "keywords={0}&type={1}", this.keywords, this.ddlCategory.SelectedValue));
        }
    }
}