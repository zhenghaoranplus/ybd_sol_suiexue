<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dict_edit.aspx.cs" Inherits="Appoa.Manage.admin.common.dict_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
                class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="javascript:history.back(-1);">
                    <span>字典项配置管理</span></a> <i class="arrow"></i><span>修改字典项配置</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>值</dt>
                <dd>
                    <asp:TextBox ID="txtcontents" runat="server" CssClass="input normal" datatype="*1-500" sucmsg=" "></asp:TextBox>
