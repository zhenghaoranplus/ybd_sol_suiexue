<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="question_course_list.aspx.cs" Inherits="Appoa.Manage.admin.common.question_course_list" %>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="question_chapter_list.aspx?course=<%#Eval("Id")%>"><%#Eval("name")%></a>
                    </td>
                    <td align="center">
                        <a href="question_chapter_list.aspx?course=<%#Eval("Id")%>">查看章节</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
