<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="file_list.aspx.cs" Inherits="Appoa.Manage.admin.classroom.file_list" %>
        ...
        $(function () {
            ...
            $('#chooseResource').click(function () {
                layer.open({
                    ...
                    content: ['/admin/dialog/document_resource.html?class_id=' + $('#ddlClass').val(), 'yes'],
                    end: function () {
                        if (flag) {
                            location.reload();
                        }
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="file_edit.aspx?action=<%=EnumCollection.ActionEnum.Add %>&class_id=<%=this.ddlClass.SelectedValue %>"><i></i><span>新增</span></a></li>
                            <li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="file_edit.aspx?action=<%=EnumCollection.ActionEnum.Modify %>&class_id=<%=this.ddlClass.SelectedValue %>&id=<%#Eval("Id")%>&page=<%=RequestHelper.GetQueryInt("page", 1) %>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
