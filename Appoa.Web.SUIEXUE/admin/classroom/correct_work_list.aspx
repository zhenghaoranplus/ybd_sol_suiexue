<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="correct_work_list.aspx.cs" Inherits="Appoa.Manage.admin.classroom.correct_work_list" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            课堂：<%=class_name %> > 章：<%=parent_name %> > 节：<%=chapter_name %>
                        </ul>
                    </div>
                    <div class="r-list">
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="currect_question_list.aspx?chapter=<%=RequestHelper.GetQueryInt("chapter") %>&id=<%#Eval("Id")%>">查看试题</a>
