<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="Appoa.Manage.admin.classroom.article_list" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.articlerec').click(function () {
                var id = $(this).attr('rid');
                var winDialog = top.dialog({
                    title: '图文资源内容',
                    url: '/admin/dialog/article_resource.aspx?id=' + id,
                    width: 800,
                    height: 600,
                    data: window //传入当前窗口
                }).showModal();
            ...
            $('#chooseResource').click(function () {
                layer.open({
                    ...
                    content: ['/admin/dialog/article_resource.html?class_id=' + $('#ddlClass').val(), 'yes'],
                    end: function () {
                        if (flag) {
                            location.reload();
                        }
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="article_edit.aspx?action=<%=EnumCollection.ActionEnum.Add %>&class_id=<%=this.ddlClass.SelectedValue %>"><i></i><span>新增</span></a></li>
                            <li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href='javascript:;' class='articlerec' rid="<%#Eval("id") %>">查看完整内容</a>
                    </td>
                    <td align="center">
                    ...
                    <td align="center">
                        <a href="article_edit.aspx?action=<%=EnumCollection.ActionEnum.Modify %>&class_id=<%=this.ddlClass.SelectedValue %>&id=<%#Eval("Id")%>&page=<%=RequestHelper.GetQueryInt("page", 1) %>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
