<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chapter_list.aspx.cs" Inherits="Appoa.Manage.admin.classroom.chapter_list" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="chapter_edit.aspx?action=<%=EnumCollection.ActionEnum.Add %>&class_id=<%=this.ddlClass.SelectedValue %>"><i></i><span>新增</span></a></li>
                        ...
                        <ItemTemplate>
                            <li class="layer-<%#Eval("chapter_level")%>">
                                <div class="tbody">
                                    ...
                                    <div class="col col-3">
                                        <a href="chapter_edit.aspx?action=<%#EnumCollection.ActionEnum.Modify %>&class_id=<%=this.ddlClass.SelectedValue %>&id=<%#Eval("id")%>"><%#Eval("name")%></a>
                                    </div>
                                    <div class="col col-4">
                                        <%--<a href="chapter_edit.aspx?action=<%#EnumCollection.ActionEnum.Add %>&class_id=<%=this.ddlClass.SelectedValue %>&parent_id=<%#Eval("id")%>">添加子级</a>--%>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="chapter_edit.aspx?action=<%#EnumCollection.ActionEnum.Modify %>&class_id=<%=this.ddlClass.SelectedValue %>&id=<%#Eval("id")%>">修改</a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="work_list.aspx?chapter=<%#Eval("id")%>">作业管理</a>
                                    </div>
                                </div>
                            </li>
                        </ItemTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                            ...
                            <a href="chapter_edit.aspx?action=<%# EnumCollection.ActionEnum.Modify %>&class_id=<%=this.ddlClass.SelectedValue %>&id=<%#Eval("id")%>">
                                <%#Eval("name")%></a>
                        </td>
