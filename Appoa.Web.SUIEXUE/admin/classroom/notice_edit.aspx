<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notice_edit.aspx.cs" Inherits="Appoa.Manage.admin.classroom.notice_edit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
                class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="javascript:history.back(-1);">
                    <span>课堂公告管理</span></a> <i class="arrow"></i><span>修改课堂公告</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">课堂公告信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    <div class="rule-single-select">
                        <asp:DropDownList ID="ddlClassroom" runat="server"></asp:DropDownList>
                    </div>
            ...
            <dl>
                <dt>封面图</dt>
                <dd>
                    <asp:TextBox ID="txtimg_src" runat="server" CssClass="input normal upload-path" datatype="*0-255" sucmsg=" "></asp:TextBox>
                    <div class="upload-box upload-img">
                    </div>
                    <br />
                    <br />
                    <img src="<%=this.txtimg_src.Text %>" class="zoomify upload-imgs" width="30%" />
                </dd>
            </dl>
            <dl>
                <dt>内容</dt>
