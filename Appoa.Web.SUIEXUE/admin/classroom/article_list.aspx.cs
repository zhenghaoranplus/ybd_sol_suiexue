...
namespace Appoa.Manage.admin.classroom
{
    public partial class article_list : Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("article_list.aspx", "keywords={0}&class_id={1}", txtKeywords.Text, this.class_id + ""));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("article_list.aspx", "keywords={0}&class_id={1}", this.keywords, this.class_id + ""));
        }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("article_list.aspx", "keywords={0}&class_id={1}", this.keywords, this.ddlClass.SelectedValue));
        }
