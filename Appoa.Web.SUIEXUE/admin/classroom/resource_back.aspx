<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resource_back.aspx.cs" Inherits="Appoa.Manage.admin.classroom.resource_back" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="javascript:history.back(-1);"><span>课堂管理</span></a>
            <i class="arrow"></i><span>资源回收站</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
                ...
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            ...
                            <li>
                                <asp:LinkButton ID="btnSave" runat="server" CssClass="save" OnClick="btnSave_Click"><i></i><span>还原</span></asp:LinkButton></li>
                            <li>
                                <asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete');"
                                    OnClick="btnDelete_Click"><i></i><span>彻底删除</span></asp:LinkButton></li>
                        </ul>
                    </div>
                    <div class="r-list">
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <%#ReturnClassroomName(Convert.ToInt32(Eval("data_id")))%>
                    </td>
                    <td>
                        <%#Eval("chapter_name")%>
                    </td>
