<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="send_message.aspx.cs" Inherits="Appoa.Manage.admin.message.send_message" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
                class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="javascript:history.back(-1);">
                    <span>消息表管理</span></a> <i class="arrow"></i><span>添加消息</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>摘要</dt>
                <dd>
                    <asp:TextBox ID="txtsubtitle" runat="server" CssClass="input normal" datatype="*0-200" sucmsg=" " TextMode="MultiLine"></asp:TextBox>
