<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_list.aspx.cs" Inherits="Appoa.Manage.admin.manager.role_list" %>
...
<div class="location">
  ...
  <i class="arrow"></i>
  <a href="manager_list.aspx"><span>系统管理</span></a>
  <i class="arrow"></i>
  <span>角色列表</span>
</div>
<!--/导航栏-->
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="role_edit.aspx?action=<%=EnumCollection.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td align="center"><a style="display:<%#Eval("role_type").ToString()=="1"?"none":"block" %>" href="role_edit.aspx?action=<%#EnumCollection.ActionEnum.Modify %>&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
