    ...
    public partial class role_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                Model.sys_manager model = GetAdminInfo(); //取得当前管理员信息
        ...
        {
            ChkAdminLevel("_sys_role_list", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除管理角色" + sucCount + "条，失败" + errorCount + "条"); //记录日志
