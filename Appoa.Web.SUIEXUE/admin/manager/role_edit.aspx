<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_edit.aspx.cs" Inherits="Appoa.Manage.admin.manager.role_edit" ValidateRequest="false" %>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlRoleType" Enabled="false" runat="server" datatype="*" errormsg="请选择角色类型！" sucmsg=" ">
            <asp:ListItem Value="2" Selected="True">系统用户</asp:ListItem>
        </asp:DropDownList>
      </div>
    </dd>
  </dl>
