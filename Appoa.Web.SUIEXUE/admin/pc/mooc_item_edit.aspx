<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mooc_item_edit.aspx.cs" Inherits="Appoa.Manage.admin.pc.mooc_item_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
                class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="javascript:history.back(-1);">
                    <span>服务项目管理</span></a> <i class="arrow"></i><span>添加服务项目</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">服务项目信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            ...
            <dl>
                <dt>摘要</dt>
                <dd>
                    <asp:TextBox ID="txtcontents" runat="server" TextMode="MultiLine" Columns="50" Rows="5" datatype="*0-20000" sucmsg=" "></asp:TextBox>
