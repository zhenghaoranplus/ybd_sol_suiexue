<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="team_edit.aspx.cs" Inherits="Appoa.Manage.admin.pc.team_edit" %>
        ...
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
                class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="javascript:history.back(-1);">
                    <span>团队信息</span></a> <i class="arrow"></i><span>添加团队</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">团队信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*右侧图</span>
                    <br />
                    <br />
            ...
            <dl>
                <dt>内容</dt>
                <dd>
                    <asp:TextBox ID="txtcontents" runat="server" TextMode="MultiLine" Columns="50" Rows="20" datatype="*0-20000" sucmsg=" "></asp:TextBox>
