<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="services_edit.aspx.cs" Inherits="Appoa.Manage.admin.pc.services_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
                class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="javascript:history.back(-1);">
                    <span>我们的服务</span></a> <i class="arrow"></i><span>添加我们的服务</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">我们的服务</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    <div class="rule-multi-radio">
                        <asp:RadioButtonList ID="rbtnStatus" runat="server"></asp:RadioButtonList>
                    </div>
                </dd>
            </dl>
            <dl>
                <dt>默认图</dt>
                <dd>
                    <asp:TextBox ID="txtimg_src" runat="server" CssClass="input normal upload-path" datatype="*1-200" sucmsg=" "></asp:TextBox>
                    <div class="upload-box upload-img">
                    </div>
                    <span class="Validform_checktip">*默认图</span>
                    <br />
                    <br />
            ...
            <dl>
                <dt>鼠标划过图</dt>
                <dd>
                    <asp:TextBox ID="txtsubtitle" runat="server" CssClass="input normal upload-path" datatype="*1-200" sucmsg=" "></asp:TextBox>
                    <div class="upload-box upload-img">
                    </div>
                    <span class="Validform_checktip">*鼠标划过图</span>
                    <br />
                    <br />
                    <img src="<%=this.txtsubtitle.Text %>" class="zoomify upload-imgs" width="20%" />
            ...
            <dl>
                <dt>内容</dt>
                <dd>
                    <asp:TextBox ID="txtcontents" runat="server" CssClass="input normal" TextMode="MultiLine" datatype="*0-20000" sucmsg=" "></asp:TextBox>
