<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mooc_item.aspx.cs" Inherits="Appoa.Manage.admin.pc.mooc_item" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i><span>慕课简介列表</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="mooc_item_edit.aspx?action=<%=EnumCollection.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <%#Enum.GetName(typeof(EnumCollection.mooc_item), Eval("category_id"))%>
                    </td>
                    <td>
                        <div title="<%#Eval("contents") %>">
                            <%#Utils.CutString(Eval("contents").ToString(), 50)%>
                        </div>
                    </td>
                    <td>
                    ...
                    <td align="center">
                        <a href="mooc_item_edit.aspx?action=<%=EnumCollection.ActionEnum.Modify %>&id=<%#Eval("Id") %>&page=<%=RequestHelper.GetQueryInt("page", 1)%>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
