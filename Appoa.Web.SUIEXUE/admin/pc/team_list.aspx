<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="team_list.aspx.cs" Inherits="Appoa.Manage.admin.pc.team_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i><span>团队列表</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="team_edit.aspx?action=<%=EnumCollection.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
                ...
                <tr>
                    ...
                    <td>
                        <div title="<%#Eval("contents") %>">
                            <%#Eval("contents").ToString().Length > 20 ? Eval("contents").ToString().Substring(0, 50) + "..." : Eval("contents")%>
                        </div>
                    </td>
                    <td align="center">
                    ...
                    <td align="center">
                        <a href="team_edit.aspx?action=<%=EnumCollection.ActionEnum.Modify %>&id=<%#Eval("Id") %>&page=<%=RequestHelper.GetQueryInt("page", 1)%>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
