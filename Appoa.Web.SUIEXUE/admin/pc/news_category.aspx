<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_category.aspx.cs" Inherits="Appoa.Manage.admin.pc.news_category" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="../right.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>新闻分类</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="news_category_edit.aspx?action=<%#EnumCollection.ActionEnum.Add %>">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                        <a href="news_category_edit.aspx?action=<%# EnumCollection.ActionEnum.Modify %>&id=<%#Eval("id")%>">
                            <%#Eval("name")%></a>
                    </td>
                    <td>
                    ...
                    <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                        <a href="news_category_edit.aspx?action=<%# EnumCollection.ActionEnum.Modify %>&id=<%#Eval("id")%>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
