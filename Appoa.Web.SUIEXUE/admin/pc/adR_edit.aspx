<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adR_edit.aspx.cs" Inherits="Appoa.Manage.admin.pc.adR_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
                class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="javascript:history.back(-1);"><span>轮播图管理</span></a> <i class="arrow"></i><span>添加轮播图</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">轮播图信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
