<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_edit.aspx.cs" Inherits="Appoa.Manage.admin.pc.news_edit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回列表页</span></a> <a href="../right.aspx"
                class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="javascript:history.back(-1);">
                    <span>新闻管理</span></a> <i class="arrow"></i><span>添加新闻</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">新闻信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            ...
            <dl>
                <dt>副标题</dt>
                <dd>
                    <asp:TextBox ID="txtsubtitle" runat="server" CssClass="input normal" TextMode="MultiLine" datatype="*0-200" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*200字以内</span>
                </dd>
            </dl>
            <dl>
