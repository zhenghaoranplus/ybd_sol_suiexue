<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adR_list.aspx.cs" Inherits="Appoa.Manage.admin.pc.adR_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="../right.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>轮播图列表</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
