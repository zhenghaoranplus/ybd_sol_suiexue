<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_list.aspx.cs" Inherits="Appoa.Manage.admin.shop.category_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="../right.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>商品分类</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
            ...
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="left" width="12%">分类名
                        </th>
                        <th align="left">标题
                        </th>
                        <th align="left" width="65">排序
                        </th>
                        <th width="12%">操作
                        </th>
                    </tr>
            ...
            <ItemTemplate>
                <tr>
                    <td align="center">
                        ...
                        <asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" />
                        <asp:HiddenField ID="hidLayer" Value='<%#Eval("category_level") %>' runat="server" />
                    </td>
                    <td align="center">
                        <div>
                            <img src="<%# string.IsNullOrEmpty(Eval("img_src").ToString())?"":Eval("img_src")%>"
                    ...
                    <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                        <a href="category_edit.aspx?action=<%# EnumCollection.ActionEnum.Add %>&parent_id=<%#Eval("id")%>" style="display: <%# Utils.StrToInt(Eval("category_level").ToString(),0) <=2 ? "" : "none"%>">添加子级</a><a href="category_edit.aspx?action=<%# EnumCollection.ActionEnum.Modify %>&id=<%#Eval("id")%>">
                                修改</a>
                    </td>
                </tr>
            </ItemTemplate>
