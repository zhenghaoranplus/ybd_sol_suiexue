<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="goods_evaluate.aspx.cs" Inherits="Appoa.Manage.admin.shop.goods_evaluate" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i><span>商品评论列表</span>
        </div>
        <!--/导航栏-->
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        <td class="comment">
                            <div class="title">
                                <span class="note"><i><%#Eval("from_nick_name")%></i><i><%#Eval("add_time", "{0:yyyy-MM-dd HH:mm:ss}")%></i></span>
                                <b>
                                    <asp:CheckBox ID="chkId" CssClass="checkall" runat="server" /><asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" />
                                </b>
                                【<%#Enum.GetName(typeof(EnumCollection.goods_group), Eval("goods_group")) %>】
                                <%#Eval("goods_title") %>
                            </div>
                            <div class="ask">
                                <%#Eval("contents")%>
