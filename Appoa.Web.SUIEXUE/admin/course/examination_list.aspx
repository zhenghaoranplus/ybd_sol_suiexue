<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="examination_list.aspx.cs" Inherits="Appoa.Manage.admin.course.examination_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i><span>试卷信息列表</span>
        </div>
        <!--/导航栏-->
        <!--工具栏-->
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="examination_edit.aspx?action=<%=EnumCollection.ActionEnum.Add %>&chapter=<%=RequestHelper.GetQueryInt("chapter") %>&page=<%=RequestHelper.GetQueryInt("page", 1) %>"><i></i><span>新增</span></a></li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="examination_edit.aspx?action=<%=EnumCollection.ActionEnum.Modify %>&chapter=<%=RequestHelper.GetQueryInt("chapter") %>&id=<%#Eval("Id")%>&page=<%=RequestHelper.GetQueryInt("page", 1) %>">修改</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
