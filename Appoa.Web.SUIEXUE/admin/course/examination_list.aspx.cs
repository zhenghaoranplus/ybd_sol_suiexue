...
{
    public partial class examination_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("_ybd_common_examination", EnumCollection.ActionEnum.View.ToString()); //检查权限
                BindData();
            }
        }
        ...
        {
            #region 组装查询条件
            string whereStr = " group_id = " + (int)EnumCollection.examination_group.精品微课测验 + " and parent_id = " + this.chapter;
            //string whereStr = " 1 = 1 ";
            ...
            if (!string.IsNullOrEmpty(_keywords))
            {
                ...
                {
                    JscriptMsg("搜索关键词中包含危险字符，检索终止！", Utils.CombUrlTxt("examination_list.aspx", "keywords={0}", ""));
                    return;
                }
            }
            ...
            string pageUrl = Utils.CombUrlTxt("examination_list.aspx", "keywords={0}&page={1}&chapter={2}", this.keywords, "__id__", this.chapter + "");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("examination_list.aspx", "keywords={0}&chapter={1}", txtKeywords.Text, this.chapter + ""));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("examination_list.aspx", "keywords={0}&chapter={1}", this.keywords, this.chapter + ""));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("examination_list.aspx", "keywords={0}&chapter={1}", this.keywords, this.chapter + ""));
        }
    }
}