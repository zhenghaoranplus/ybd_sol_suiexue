<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chapter_course_list.aspx.cs" Inherits="Appoa.Manage.admin.course.chapter_course_list" %>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="chapter_list.aspx?course_id=<%#Eval("Id")%>"><%#Eval("name")%></a>
                    </td>
                    <td align="center">
                        <a href="chapter_list.aspx?course_id=<%#Eval("Id")%>">查看章节</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
