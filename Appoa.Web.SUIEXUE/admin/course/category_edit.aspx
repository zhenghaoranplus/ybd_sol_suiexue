<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_edit.aspx.cs" Inherits="Appoa.Manage.admin.course.category_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i><a href="category_list.aspx"><span>课程分类</span></a> <i class="arrow"></i><span>编辑课程分类信息</span>
        </div>
        <div class="line10">
        </div>
        <!--/导航栏-->
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">编辑课程分类信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
