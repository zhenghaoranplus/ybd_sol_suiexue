...
namespace Appoa.Manage.admin.course
{
    public partial class adR_list : Web.UI.ManagePage
    {
        ...
        private void BindData()
        {
            ...
            this.rptList.DataSource = bll.GetListByPage("ad_group_id = " + (int)EnumCollection.adR_group.精品微课轮播图, "ad_group_id,ad_sort_id", this.page, this.pageSize);
            this.rptList.DataBind();

            this.totalCount = bll.GetRecordCount("ad_group_id = " + (int)EnumCollection.adR_group.精品微课轮播图);
            //绑定页码
        ...
        {
            ChkAdminLevel("_course_adR", EnumCollection.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.common_adR bll = new BLL.common_adR();
            ...
            AddAdminLog(EnumCollection.ActionEnum.Delete.ToString(), "删除广告位与数据对应表" + sucCount + "条，失败" + errorCount + "条"); //记录日志
