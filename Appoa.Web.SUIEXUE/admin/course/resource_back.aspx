<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resource_back.aspx.cs" Inherits="Appoa.Manage.admin.course.resource_back" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="javascript:;"><span>精品微课</span></a>
                ...
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            ...
                            <li><asp:LinkButton ID="btnSave" runat="server" CssClass="save" OnClick="btnSave_Click"><i></i><span>还原</span></asp:LinkButton></li>
                            <li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <%#ReturnCourseName(Convert.ToInt32(Eval("data_id"))) %>
                    </td>
                    <td>
                        <%#Eval("chapter_name")%>
                    </td>
