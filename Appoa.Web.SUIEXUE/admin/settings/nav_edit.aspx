<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_edit.aspx.cs" Inherits="Appoa.Manage.admin.settings.nav_edit"
...
<body class="mainbody">
    ...
    <div class="location">
        <a href="nav_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="nav_list.aspx">
                <span>导航列表</span></a> <i class="arrow"></i><span>编辑后台导航</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div class="tab-content">
        ...
        <dl>
            <dt>调用别名</dt>
            <dd>
                <asp:TextBox ID="txtName" runat="server" CssClass="input normal" datatype="/^[a-zA-Z0-9\-\_]{2,50}$/"
                    errormsg="请填写正确的ID" sucmsg=" "></asp:TextBox>
