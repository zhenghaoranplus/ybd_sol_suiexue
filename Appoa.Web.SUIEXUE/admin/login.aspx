<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Appoa.Manage.admin.login" %>
...
<body class="loginbody">
    ...
    <div class="login-wrap">
        ...
        <div class="login-form">
            <div class="col">
                <asp:TextBox ID="txtUserName" runat="server" CssClass="login-input" placeholder="管理员账号"
                    title="管理员账号"></asp:TextBox>
                <label class="icon user" for="txtUserName">
                </label>
            </div>
            <div class="col">
                <asp:TextBox ID="txtPassword" runat="server" CssClass="login-input" TextMode="Password"
                    placeholder="管理员密码" title="管理员密码"></asp:TextBox>
    ...
    <div class="copy-right">
        <p>
            郑州市乙丙丁软件科技有限公司 CopyRight 2014-2016.</p>
    </div>
    </form>
</body>
</html>
