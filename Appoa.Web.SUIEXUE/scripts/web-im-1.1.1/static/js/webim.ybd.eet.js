...
var sendText = function () {
    ...
    conn.sendTextMessage({
        to: 'S18695938979', //用户登录名，SDK根据AppKey和domain组织jid，如easemob-demo#chatdemoui_**TEST**@easemob.com，中"to:TEST",下同
        msg: 'hello world！', //文本消息
        ext: { "UserAvatar": "http://a.hiphotos.baidu.com/zhidao/pic/item/f9dcd100baa1cd11aa2ca018bf12c8fcc3ce2d74.jpg", "UserNick": "裴杰"}//用户自扩展的消息内容（群聊用法相同）
    });
    return;
    */
    if (textSending) {
