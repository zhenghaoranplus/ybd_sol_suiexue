...
namespace Appoa.BLL
{
    ...
    {
        private readonly DAL.user_collection dal = new DAL.user_collection();
        /// <summary>
        /// 无参构造函数
        /// </summary>
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.user_collection model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.user_collection model)
		{
        ...
        /// 得到一个对象实体（或者null）
        /// </summary>
        public Model.user_collection GetModel(int ID)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.user_collection DataRowToModel(DataRow row)
        {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>      
		public List<Model.user_collection> DataTableToList(DataTable dt)
		{
			List<Model.user_collection> modelList = new List<Model.user_collection>();
            if (dt != null)
            {
				Model.user_collection model;
        ...
        /// 获得数据列表List<T>
        /// </summary>
        public List<Model.user_collection> GetModelList(string whereStr)
        {
        ...
        /// <returns></returns>
        public Model.user_collection GetModel(string whereStr)
        {
            DataTable dt = dal.GetList(whereStr).Tables[0];
            Model.user_collection model = dt.Rows.Count > 0 ? DataRowToModel(dt.Rows[0]) : null;
            return model;
        }
        ...
        /// <returns></returns>
        public List<Model.user_collection> GetModelList(int Top, string whereStr, string filedOrder)
        {
        ...
        /// <param name="filedOrder">排序字段Order By + filedOrder (不可为空)</param>
        /// <returns></returns>
        public Model.user_collection GetModel(int Top, string whereStr, string filedOrder)
        {
        ...
        /// 分页获取数据列表list<T> 1
        /// </summary>
        public List<Model.user_collection> GetModelListByPage(string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        /// 分页获取数据列表list<T> 2
        /// </summary>
        public List<Model.user_collection> GetModelListByPage(string DIY_FILED, string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
