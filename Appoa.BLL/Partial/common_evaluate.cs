...
namespace Appoa.BLL
{
    ...
    {
        public DataTable GetList(string field, string viewname, string where)
        {
            return dal.GetList(field, viewname, where).Tables[0];
        }
        ...
        {
            return dal.GetRecordAvg(viewname, whereStr);
        }
    }
}