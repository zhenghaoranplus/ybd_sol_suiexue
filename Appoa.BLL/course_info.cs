...
namespace Appoa.BLL
{
    ...
    {
        private readonly DAL.course_info dal = new DAL.course_info();
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public course_info()
        ...
        /// 得到一个对象实体（或者null）
        /// </summary>
        public Model.course_info GetModel(int ID)
        {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>      
		public List<Model.course_info> DataTableToList(DataTable dt)
		{
			List<Model.course_info> modelList = new List<Model.course_info>();
            if (dt != null)
            {
        ...
        /// 获得数据列表List<T>
        /// </summary>
        public List<Model.course_info> GetModelList(string whereStr)
        {
        ...
        /// <returns></returns>
        public List<Model.course_info> GetModelList(int Top, string whereStr, string filedOrder)
        {
        ...
        /// 分页获取数据列表list<T> 1
        /// </summary>
        public List<Model.course_info> GetModelListByPage(string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        /// 分页获取数据列表list<T> 2
        /// </summary>
        public List<Model.course_info> GetModelListByPage(string DIY_FILED, string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
