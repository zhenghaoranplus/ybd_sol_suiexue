...
namespace Appoa.BLL
{
    ...
    {
        private readonly DAL.classroom_info dal = new DAL.classroom_info();
        /// <summary>
        /// 无参构造函数
        /// </summary>
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.classroom_info model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.classroom_info model)
		{
        ...
        /// 得到一个对象实体（或者null）
        /// </summary>
        public Model.classroom_info GetModel(int ID)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.classroom_info DataRowToModel(DataRow row)
        {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>      
		public List<Model.classroom_info> DataTableToList(DataTable dt)
		{
			List<Model.classroom_info> modelList = new List<Model.classroom_info>();
            if (dt != null)
            {
				Model.classroom_info model;
        ...
        /// 获得数据列表List<T>
        /// </summary>
        public List<Model.classroom_info> GetModelList(string whereStr)
        {
        ...
        /// <returns></returns>
        public Model.classroom_info GetModel(string whereStr)
        {
            DataTable dt = dal.GetList(whereStr).Tables[0];
            Model.classroom_info model = dt.Rows.Count > 0 ? DataRowToModel(dt.Rows[0]) : null;
            return model;
        }
        ...
        /// <returns></returns>
        public List<Model.classroom_info> GetModelList(int Top, string whereStr, string filedOrder)
        {
        ...
        /// <param name="filedOrder">排序字段Order By + filedOrder (不可为空)</param>
        /// <returns></returns>
        public Model.classroom_info GetModel(int Top, string whereStr, string filedOrder)
        {
        ...
        /// 分页获取数据列表list<T> 1
        /// </summary>
        public List<Model.classroom_info> GetModelListByPage(string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        /// 分页获取数据列表list<T> 2
        /// </summary>
        public List<Model.classroom_info> GetModelListByPage(string DIY_FILED, string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
