...
namespace Appoa.BLL
{
    ...
    {
        private readonly DAL.common_evaluate dal = new DAL.common_evaluate();
        /// <summary>
        /// 无参构造函数
        /// </summary>
        ...
        /// 得到一个对象实体（或者null）
        /// </summary>
        public Model.common_evaluate GetModel(int ID)
        {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>      
		public List<Model.common_evaluate> DataTableToList(DataTable dt)
		{
			List<Model.common_evaluate> modelList = new List<Model.common_evaluate>();
            if (dt != null)
            {
				Model.common_evaluate model;
        ...
        /// 获得数据列表List<T>
        /// </summary>
        public List<Model.common_evaluate> GetModelList(string whereStr)
        {
        ...
        /// <returns></returns>
        public List<Model.common_evaluate> GetModelList(int Top, string whereStr, string filedOrder)
        {
        ...
        /// 分页获取数据列表list<T> 1
        /// </summary>
        public List<Model.common_evaluate> GetModelListByPage(string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        /// 分页获取数据列表list<T> 2
        /// </summary>
        public List<Model.common_evaluate> GetModelListByPage(string DIY_FILED, string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
