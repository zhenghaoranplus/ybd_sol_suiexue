...
namespace Appoa.BLL
{
    ...
    {
        private readonly DAL.goods_spec_type dal = new DAL.goods_spec_type();
        /// <summary>
        /// 无参构造函数
        /// </summary>
        ...
        /// 得到一个对象实体（或者null）
        /// </summary>
        public Model.goods_spec_type GetModel(int ID)
        {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>      
		public List<Model.goods_spec_type> DataTableToList(DataTable dt)
		{
			List<Model.goods_spec_type> modelList = new List<Model.goods_spec_type>();
            if (dt != null)
            {
				Model.goods_spec_type model;
        ...
        /// 获得数据列表List<T>
        /// </summary>
        public List<Model.goods_spec_type> GetModelList(string whereStr)
        {
        ...
        /// <returns></returns>
        public List<Model.goods_spec_type> GetModelList(int Top, string whereStr, string filedOrder)
        {
        ...
        /// 分页获取数据列表list<T> 1
        /// </summary>
        public List<Model.goods_spec_type> GetModelListByPage(string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        /// 分页获取数据列表list<T> 2
        /// </summary>
        public List<Model.goods_spec_type> GetModelListByPage(string DIY_FILED, string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
