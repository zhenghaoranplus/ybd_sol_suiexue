...
namespace Appoa.BLL
{
    ...
    {
        private readonly DAL.answer_result dal = new DAL.answer_result();
        /// <summary>
        /// 无参构造函数
        /// </summary>
        ...
        /// 得到一个对象实体（或者null）
        /// </summary>
        public Model.answer_result GetModel(int ID)
        {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>      
		public List<Model.answer_result> DataTableToList(DataTable dt)
		{
			List<Model.answer_result> modelList = new List<Model.answer_result>();
            if (dt != null)
            {
        ...
        /// 获得数据列表List<T>
        /// </summary>
        public List<Model.answer_result> GetModelList(string whereStr)
        {
        ...
        /// <returns></returns>
        public List<Model.answer_result> GetModelList(int Top, string whereStr, string filedOrder)
        {
        ...
        /// 分页获取数据列表list<T> 1
        /// </summary>
        public List<Model.answer_result> GetModelListByPage(string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        /// 分页获取数据列表list<T> 2
        /// </summary>
        public List<Model.answer_result> GetModelListByPage(string DIY_FILED, string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
