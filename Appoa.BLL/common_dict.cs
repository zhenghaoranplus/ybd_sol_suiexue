...
namespace Appoa.BLL
{
    ...
    {
        private readonly DAL.common_dict dal = new DAL.common_dict();
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public common_dict()
        ...
        /// 得到一个对象实体（或者null）
        /// </summary>
        public Model.common_dict GetModel(int ID)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.common_dict DataRowToModel(DataRow row)
        {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>      
		public List<Model.common_dict> DataTableToList(DataTable dt)
		{
			List<Model.common_dict> modelList = new List<Model.common_dict>();
            if (dt != null)
            {
				Model.common_dict model;
        ...
        /// 获得数据列表List<T>
        /// </summary>
        public List<Model.common_dict> GetModelList(string whereStr)
        {
        ...
        /// <returns></returns>
        public Model.common_dict GetModel(string whereStr)
        {
            DataTable dt = dal.GetList(whereStr).Tables[0];
            Model.common_dict model = dt.Rows.Count > 0 ? DataRowToModel(dt.Rows[0]) : null;
            return model;
        }
        ...
        /// <returns></returns>
        public List<Model.common_dict> GetModelList(int Top, string whereStr, string filedOrder)
        {
        ...
        /// <param name="filedOrder">排序字段Order By + filedOrder (不可为空)</param>
        /// <returns></returns>
        public Model.common_dict GetModel(int Top, string whereStr, string filedOrder)
        {
        ...
        /// 分页获取数据列表list<T> 1
        /// </summary>
        public List<Model.common_dict> GetModelListByPage(string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
        ...
        /// 分页获取数据列表list<T> 2
        /// </summary>
        public List<Model.common_dict> GetModelListByPage(string DIY_FILED, string whereStr, string orderby, int pageIndex, int pageSize)
        {
            int startIndex = (pageIndex - 1) * pageSize + 1;
            int endIndex = pageIndex * pageSize;
